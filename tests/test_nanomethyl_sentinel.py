...
import pytest
from nanomethyl_sentinel.models import FrontierPayload, ExecutionStatus
from nanomethyl_sentinel.engine import FrontierDomainEngine
from nanomethyl_sentinel.agents import SquiggleCurrentDeviationAgent, CpGIslandAggregateScorerAgent, DifferentialMethylationAgent, NanoMethylCoordinator
from nanomethyl_sentinel.cli import main


def test_sub_agents():
    a1 = SquiggleCurrentDeviationAgent()
    ...
    a2 = CpGIslandAggregateScorerAgent()
    ...
    a3 = DifferentialMethylationAgent()
...
def test_coordinator():
    ...
    assert "Oxford Nanopore Epigenomic Modification Specs" in ans or "specifications" in ans
